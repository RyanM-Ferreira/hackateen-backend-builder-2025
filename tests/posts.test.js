...
describe('Testes para o endpoint /posts', () => {
    ...
    it('Deve deletar o post com sucesso', async () => {
        ...
        expect(postdelete.body.response).toHaveProperty('mensagem');
        expect(postdelete.body.response.mensagem).toBe(`Post ${postResponse.body.postId} removido com sucesso!`);
    });
